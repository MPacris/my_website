      ...
      <div className="row">
        ...
        <div className="col-sm-4">
          <div className="card">
            ...
            <div className="back">
              ...
              <span>1998-2002: Bachelor of Arts</span>
                <div className="caption">
                Originally a Theatre major (long story), I chose to change my major to Political Science and minor in Speech Communication as a path to pre-law.  My coursework consisted of research projects and presentations.  One of my favorite projects was based on the media’s influence on polling numbers and how demographics shaped campaigns.  This is where I believe my passionate curiosity, analytical mindset, and ability to be comfortable while being uncomfortable began to take shape and become strengths I could rely on in the future.
                </div>
        ...
        <div className="col-sm-4">
          <div className="card">
            ...
            <div className="back">
              <div className="details">
              <span>2001-2005: Retail Store Management</span>
                <div className="caption">
        ...
        <div className="col-sm-4">
          <div className="card">
            ...
            <div className="back">
              <div className="details">
              <span>2005-2007: Masters of Business Administration</span>
                <div className="caption">
        ...
        <div className="col-sm-4">
          <div className="card">
            ...
            <div className="back">
              <div className="details">
              <span>2006-2008: General Laborer</span>
                <div className="caption">
        ...
        <div className="col-sm-4">
          <div className="card">
            ...
            <div className="back">
              <div className="details">
              <span>2008-2011: Supply Chain Supervisor</span>
                <div className="caption">
        ...
        <div className="col-sm-4">
          <div className="card">
            ...
            <div className="back">
              <div className="details">
              <span>2011-2013: Vendor Managed Inventory Specialist</span>
                <div className="caption">
        ...
        <div className="col-sm-4">
          <div className="card">
            ...
            <div className="back">
              <div className="details">
              <span>2013-2016: Operations Business Manager</span>
                <div className="caption">
        ...
        <div className="col-sm-4">
          <div className="card">
            ...
            <div className="back">
              <div className="details">
              <span>2016-2022:  Corporate Audit/ Document Manager</span>  
                <div className="caption">

At the end of 2016, as the Quality department moved out from underneath the Operations department, I was presented with the opportunity to take on a newly created role of Corporate Audit/ Document Manager.  In this role, I applied a hybrid project management approach that blended traditional/waterfall, agile/scrum, and six sigma methodologies to lead continuous improvement projects, ensure internal Reily sites were prepared for audits and maintained quality standards, and collaborate with new copackers to meet product launch requirements. Additionally, I managed cross-functional teams during Rainforest Alliance Certification projects, ensuring collaboration across departments.  In this role I conducted food safety and quality audits on co-packers, suppliers, and our own Reily Foods Company sites, ensuring compliance with GFSI and FDA standards.  To enhance our document management capabilities, I was responsible for the implementation of a document management program utilizing TraceGains which significantly improved the supplier approval and monitoring process.  Another responsibility I took on was managing supplier and copacker nonconformances.  I engaged in collaborative efforts with suppliers, implementing root cause analysis and corrective action strategies to resolve issues effectively.  I also utilized Power BI reports to review nonconformance and defect data, working closely with site QA Managers to drive continuous improvement efforts. My collaboration with site QA Managers also extended to creating HACCP/Food Safety Plans, devising international adulteration risk assessments, formulating supply chain vulnerability assessments, and leading continuous improvement initiatives.  I also created an auditing tool within Redzone which leveraged Tableau to deliver actionable insights and data visualization. My proficiency in utilizing SQL reports was instrumental in leading initiatives for conducting Traceability Exercises within Microsoft Dynamics AX. Furthermore, I took charge of mock recalls and incident reporting activities, utilizing SQL reports, and fostering cross-functional collaboration to ensure effective outcomes. Although my title had ‘audit/ document manager’ in it, I wore many hats and led projects well beyond my initial job description.  
</div>
        ...
        <div className="col-sm-4">
          <div className="card">
            ...
            <div className="back">
              ...
              <span>2023:  devCodeCamp Full Stack Developer Bootcamp</span>
                <div className="caption">
                 After being laid off in November of 2022, I decided to take a few months off to rethink my next career move.  In my previous roles, I took those on to fill a need at the company.  After giving it a lot of thought, I wanted to find a way to pivot into a career in the technology industry.  As someone who witnessed the dawn of a new era coming from the days of commodore 64s and DOS commands, Oregon Trail, Duke Nukem 3D LAN in the computer lab, dial up modems, Prodigy, AOL chatrooms, T1 connections in the dorms, Napster, Limewire crashing the family computer, coding on Myspace and making sure my top 8 was a representation of who I am, etc… I wanted to take a shot in getting into tech industry.  That led me to pursuing a fullstack developer bootcamp.  At devCodeCamp, I was exposed to programming languages and technologies, including Python, Django, Java, Spring, JavaScript, HTML, CSS, React.js, Flask, and many others. I also gained hands-on experience with essential tools and practices like AWS, Docker, Git & GitHub, Jenkins, Kubernetes, and more.  My education at devCodeCamp was a 16-week, project-based coding bootcamp that focused on computer science concepts, building real-world full-stack applications, and deploying them to the cloud utilizing DevOps best practices. Throughout the program, I honed my skills in various programming languages, object-oriented programming, algorithm development, web design and development, testing, agile methodologies, and more.  My experience at devCodeCamp provided me with a strong foundation in full-stack development, equipped me with the skills and knowledge needed to hopefully break into the technology industry, and allowed me to work on meaningful projects that showcased my abilities.  Most importantly, it was something that I had to do to prove to myself that I still had the analytical skills, learning capability, and competitive edge to take on whatever my new career path throws my way.  It is my resilience and abilities that I have faith in that make me believe that I can be a valuable asset to any organization that takes a chance on me. 
                </div>
